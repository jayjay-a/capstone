class ProjectTypesController < ApplicationController
  ...
  def index
    if user_signed_in?
      ...
      @project_types = @search.result.order("created_at DESC").page(params[:page]).per(50)
    else
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to project_types_url, notice: 'Project type was successfully deleted.' }
  ...
  private
    ...
    def project_type_params
      params.require(:project_type).permit(:project_type_description)
    end
end
