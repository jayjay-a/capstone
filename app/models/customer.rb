class Customer < ApplicationRecord
  ...
  validates :customer_rep_name_1, length: { maximum: 70 }, format: { with: /\A[^0-9`!@#\$%\^&*+_=(){}]+(?: [a-zA-Z]+)?\z/ }
  ...
  validates :customer_city, allow_blank: true, length: { maximum: 64 }, format: { with: /\A[^0-9`!@#\$%\^&*+_=(){}]+(?: [a-zA-Z]+)?\z/ }
