...
class StatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create state" do
    assert_difference('State.count') do
      post states_url, params: { state: { state_abbrev: @state.state_abbrev, state_name: @state.state_name } }
    end
  ...
  test "should update state" do
    patch state_url(@state), params: { state: { state_abbrev: @state.state_abbrev, state_name: @state.state_name } }
