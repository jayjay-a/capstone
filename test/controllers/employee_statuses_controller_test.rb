...
class EmployeeStatusesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create employee_status" do
    assert_difference('EmployeeStatus.count') do
      post employee_statuses_url, params: { employee_status: { employee_status_description: @employee_status.employee_status_description } }
    end
  ...
  test "should update employee_status" do
    patch employee_status_url(@employee_status), params: { employee_status: { employee_status_description: @employee_status.employee_status_description } }
