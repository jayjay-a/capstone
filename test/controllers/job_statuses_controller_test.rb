...
class JobStatusesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create job_status" do
    assert_difference('JobStatus.count') do
      post job_statuses_url, params: { job_status: { job_status_description: @job_status.job_status_description } }
    end
  ...
  test "should update job_status" do
    patch job_status_url(@job_status), params: { job_status: { job_status_description: @job_status.job_status_description } }
