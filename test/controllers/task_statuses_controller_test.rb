...
class TaskStatusesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create task_status" do
    assert_difference('TaskStatus.count') do
      post task_statuses_url, params: { task_status: { task_status_description: @task_status.task_status_description } }
    end
  ...
  test "should update task_status" do
    patch task_status_url(@task_status), params: { task_status: { task_status_description: @task_status.task_status_description } }
