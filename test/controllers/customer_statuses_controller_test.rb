...
class CustomerStatusesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create customer_status" do
    assert_difference('CustomerStatus.count') do
      post customer_statuses_url, params: { customer_status: { customer_status_description: @customer_status.customer_status_description } }
    end
  ...
  test "should update customer_status" do
    patch customer_status_url(@customer_status), params: { customer_status: { customer_status_description: @customer_status.customer_status_description } }
