...
class TaskNotesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create task_note" do
    assert_difference('TaskNote.count') do
      post task_notes_url, params: { task_note: { task_id: @task_note.task_id, task_note_owner: @task_note.task_note_owner, task_notes: @task_note.task_notes, taske_note_date: @task_note.taske_note_date } }
    end
  ...
  test "should update task_note" do
    patch task_note_url(@task_note), params: { task_note: { task_id: @task_note.task_id, task_note_owner: @task_note.task_note_owner, task_notes: @task_note.task_notes, taske_note_date: @task_note.taske_note_date } }
